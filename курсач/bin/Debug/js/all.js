...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","1. Работа с данными","2. Поиск","3. Подобрать врача","4. Оформление заказа"],
    DREX_NODE_LINKS: ["index.htm","rabota_s_dannymi.htm","poisk.htm","3__podobrat_vracha.htm","4__oformlenie_zakaza.htm"],
    DREX_NODE_CHILD_START: [1,5,5,5,5],
    DREX_NODE_CHILD_END: [5,5,5,5,5],
    DREX_MENU_TYPE: 1,
